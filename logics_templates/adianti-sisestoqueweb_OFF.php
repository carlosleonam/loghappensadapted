...
$menu = [
    "icon" => "logos:php",
    "color" => "red",
    "title" => "Serraria Laragon error.log",
    // "file" => "/var/www/cakephp/logs/error.log"
    // "file" => "D:\laragon\www\sisestoque_web__do\\tmp\php_errors.log"
    "file" => "G:\laragon\www\adianti_studio\serraria_theme3_adfw_55\\tmp\php_errors.log"
...
// $content_string = file_get_contents($menu['file'],0,null,511000); //read the file
